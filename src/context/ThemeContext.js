...
export const ThemeContextProvider = ({ children }) => {
  ...
  const setNewColor = value => {
    ...
    root.style.setProperty(
      "--background-color",
      value === "light" ? theme.colors.bg.primary : darkTheme.colors.bg.primary
    )
    root.style.setProperty(
      "--primary-color",
      value === "light" ? theme.colors.ui.primary : darkTheme.colors.ui.primary
    )
    root.style.setProperty(
      "--ui-decoration",
      value === "light"
        ? theme.colors.ui.decoration
        : darkTheme.colors.ui.decoration
    )
    root.style.setProperty(
      "--text-accent",
      value === "light"
        ? theme.colors.text.accent
        : darkTheme.colors.text.accent
    )
    root.style.setProperty(
      "--text-body",
      value === "light" ? theme.colors.text.body : darkTheme.colors.text.body
    )
  ...
  return (
    <>
      <ThemeContext.Provider
        value={{ theme: currentTheme, toggleTheme, colorMode }}
      >
        {children}
      </ThemeContext.Provider>
    </>
